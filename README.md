A collection of mini utility tools, collected in [fabge/tools](https://github.com/fabge/tools).
...
* [Markdown Table Formatter](md-table-formatter.html) - Paste messy markdown tables and convert them to a compact format with minimal whitespace.
